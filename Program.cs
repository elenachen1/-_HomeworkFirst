Console.WriteLine("Данная программа осуществляет демонстрацию домашнего задания. Далее будут представленны 5 задач, переход между задачами осуществляется при помощи выбора номера задания ");
